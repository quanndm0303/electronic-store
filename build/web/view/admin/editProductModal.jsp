<%-- 
    ...
    Created on : Mar 15, 2024, 6:06:54 PM
    Author     : Acer
--%>
<%-- 
    Author     : 4USER-FPT
            ...
            <div class="modal-body">
                <form id="editBookForm" action="product?action=edit" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="colorEditInput" name="color">
                        <div id="colorEditError" class="error"></div>
                    </div>
                    <!--Category-->
                    <div class="form-group">
...
<script>
    ...
    function editProductModal(button) {
        ...
        let color = $(button).closest('tr').find('td[name="color"]').text().trim();
